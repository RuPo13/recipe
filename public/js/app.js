...
/*!**********************************!*\
  !*** ./resources/js/routes.json ***!
  \**********************************/
/*! exports provided: , users.index, users.create, users.store, users.show, users.edit, users.update, users.destroy, login, logout, register, password.request, password.email, password.reset, password.update, password.confirm, home, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"\":\"{any}\",\"users.index\":\"api/users\",\"users.create\":\"api/users/create\",\"users.store\":\"api/users\",\"users.show\":\"api/users/{user}\",\"users.edit\":\"api/users/{user}/edit\",\"users.update\":\"api/users/{user}\",\"users.destroy\":\"api/users/{user}\",\"login\":\"login\",\"logout\":\"logout\",\"register\":\"register\",\"password.request\":\"password/reset\",\"password.email\":\"password/email\",\"password.reset\":\"password/reset/{token}\",\"password.update\":\"password/reset\",\"password.confirm\":\"password/confirm\",\"home\":\"home\"}");
...
__webpack_require__(/*! /Users/ruslanponomarov/Sites/dub/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/ruslanponomarov/Sites/dub/resources/sass/app.scss */"./resources/sass/app.scss");
